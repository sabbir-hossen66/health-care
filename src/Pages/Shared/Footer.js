...
const Footer = () => {
    return (
        <div>
            <footer
                style={{ background: `url("https://i.ibb.co/wJvvB9K/footer.png")`, backgroundSize: 'cover' }}
                className="p-10">
                <div className='footer'>
                    <div>
                        ...
                        <p className='text-xl text-semibold'>Doc<span className='text-secondary text-semibold'>min</span>.</p><p>Providing reliable tech since 1992</p>
                    </div>
                    <div>
